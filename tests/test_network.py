...
class TestNetworkForceLayout(TestCase):
    def test_simulation(self):
        ...
        layout = NetworkForceLayout(net, attraction=0.03, normalize_attraction=True, gravity=-0.002)
        ...
        layout.set_position(net.layers['output_layer'], output_positions.view(-1, 2), fix=True)
